...
const CONTACT_LINKS = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/mayhesta-gilang-maulana-034327271/",
    content: "/mayhesta-gilang-maulana",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/vilixvoid",
    content: "/vilixvoid",
...
const TOOLS = [
  ...
  },
  {
    name: "Kotlin",
    content: "Next.js is a React framework for production",
    icon: <SiKotlin size={"50px"} color="#fff" />,
    color: "#000000",
  },
  {
    name: "Android_Studio",
    content: "Next.js is a React framework for production",
    icon: <SiAndroidstudio size={"50px"} color="#3f51b5" />,
    color: "#000000",
  },
];
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! Im Mayhesta Gilang Maulana, a Web and Android Developer with hands-on experience in building responsive web applications and scalable mobile apps.
            ...
            <p className="mb-10">
             When Im not coding, you can find me exploring new tech trends, learning UI/UX concepts, or enjoying a good cup of coffee while brainstorming my next web or Android project.
